...
* Valid Layout Names are `host`, `nes`, `snes`, `snesrando`, `fullscreen`, `fullscreenrace`, `fullscreenrando`, `fullscreenrandorace`, `widescreen`, `gb`, `gbrace`, `gba`, `gbarace`, `gbarando`, `gbarandorace`, `ds`, `dstall`, `3ds`.
